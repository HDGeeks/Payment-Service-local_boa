from .views import SubscriptionViewset,PaymentViewset,notify,SubscribeWithTelebirrViewSet,subscribers_count
...
router.register(r'subscribe_with_telebirr',SubscribeWithTelebirrViewSet, basename='subscribe_with_telebirr')
