    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_subscription_fee', models.IntegerField(default=0)),
                ('weekly_subscription_fee', models.IntegerField(default=0)),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_type', models.CharField(choices=[('DAILY', 'daily'), ('WEEKLY', 'weekly'), ('MONTHLY', 'monthly'), ('YEARLY', 'yearly')], default='MONTHLY', max_length=50)),
                ('payment_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='subscription.subscription_payment_info')),
                ('payment_id_from_superapp', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='super_app.superapp_payment_info')),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
